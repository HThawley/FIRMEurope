...
def profile(
    ...
    if disp:
        ...
        print(
            ...
            "\t|",
            ctwt * zero_safe_division(solution.time_transmission, solution.calls_transmission),
            "cc \n backfill\t\t\t",
            solution.calls_backfill,
            "\t|",
            ctwt * solution.time_backfill,
            "\t|",
            ctwt * zero_safe_division(solution.time_backfill, solution.calls_backfill),
            # "cc \n basic\t\t\t\t",
            ...
            * zero_safe_division(
            ...
            "\t|",
            ctwt * zero_safe_division(solution.time_interconnection0, solution.calls_interconnection0),
            "cc \n interconnection1\t\t",
            solution.calls_interconnection1,
            "\t|",
            ctwt * solution.time_interconnection1,
            "\t|",
            ctwt * zero_safe_division(solution.time_interconnection1, solution.calls_interconnection1),
            "cc \n interconnection2\t\t",
            solution.calls_interconnection2,
            "\t|",
            ctwt * solution.time_interconnection2,
            "\t|",
            ctwt * zero_safe_division(solution.time_interconnection2, solution.calls_interconnection2),
            "cc \n interconnection3\t\t",
            solution.calls_interconnection3,
            "\t|",
            ctwt * solution.time_interconnection3,
            "\t|",
            ctwt * zero_safe_division(solution.time_interconnection3, solution.calls_interconnection3),
            "cc \n storage_behavior\t",
            solution.calls_storage_behavior,
            "\t|",
            ctwt * solution.time_storage_behavior,
            "\t|",
            ctwt * zero_safe_division(solution.time_storage_behavior, solution.calls_storage_behavior),
            "cc \n storage_behaviort\t",
            solution.calls_storage_behaviort,
            "\t|",
            ctwt * solution.time_storage_behaviort,
            "\t|",
            ctwt * zero_safe_division(solution.time_storage_behaviort, solution.calls_storage_behaviort),
            "cc \n spilldef\t\t\t",
            solution.calls_spilldef,
            "\t|",
            ctwt * solution.time_spilldef,
            "\t|",
            ctwt * zero_safe_division(solution.time_spilldef, solution.calls_spilldef),
            "cc \n spilldeft\t\t\t",
            solution.calls_spilldeft,
            "\t|",
            ctwt * solution.time_spilldeft,
            "\t|",
            ctwt * zero_safe_division(solution.time_spilldeft, solution.calls_spilldeft),
            "cc \n update_soc\t\t\t",
            solution.calls_update_soc,
            "\t|",
            ctwt * solution.time_update_soc,
            "\t|",
            ctwt * zero_safe_division(solution.time_update_soc, solution.calls_update_soc),
            "cc \n update_soct\t\t\t",
            solution.calls_update_soct,
            "\t|",
            ctwt * solution.time_update_soct,
            "\t|",
            ctwt * zero_safe_division(solution.time_update_soct, solution.calls_update_soct),
            "cc \n unbalancedt\t\t\t",
            solution.calls_unbalancedt,
            "\t|",
            ctwt * solution.time_unbalancedt,
            "\t|",
            ctwt * zero_safe_division(solution.time_unbalancedt, solution.calls_unbalancedt),
            "cc \n unbalanced\t\t\t",
            solution.calls_unbalanced,
            "\t|",
            ctwt * solution.time_unbalanced,
            "\t|",
            ctwt * zero_safe_division(solution.time_unbalanced, solution.calls_unbalanced),
            "cc \n -- ",
            solution.LCOE,
            solution.Penalties,
        )
